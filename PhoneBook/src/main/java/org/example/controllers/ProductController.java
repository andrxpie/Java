...
public class ProductController {
    ...
    public ResponseEntity<String> saveProduct(@Valid @ModelAttribute ProductCreateDto productModel, BindingResult bindingResult) {
    ...
    public ResponseEntity<String> updateProduct(@Valid @ModelAttribute ProductCreateDto productModel , BindingResult bindingResult) {
        if (bindingResult.hasErrors()) {
            return ResponseEntity.badRequest().body(bindingResult.getAllErrors().toString());
        } try {
